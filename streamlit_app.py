...
def create_app(df):
    ...
    # Add data description from the first code
    ...
    # Plotly Bar Chart for Annual Mean Age
    ...
    # Plotly Pie Chart for Skin Color Distribution
    ...
    # Matplotlib Visualization for Mean Price of Slaves in Each Age Group
    ...
    # Calculate correlations for different age groups between age and price
